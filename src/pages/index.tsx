    ...
    <>
      ...
      <section className="flex flex-col items-center justify-center w-full p-8 text-base text-orange-800 bg-champagne" id="what-we-value">
        ...
        <div className="flex flex-row items-center justify-center max-w-screen-lg">
          ...
          <Card title="Creativity" text={['Lorem Ipsum is simply dummy text.', 'It is long established fact that a reader will be distracted.', 'It has survived not only five centuries, but also electronic typesetting.']} type="secondary"/>
